  ...
  if (intentName === "Hoi_Gia_San_Pham") {
    ...
    try {
      ...
      const sqlQuery = `
                ...
                FROM SanPham sp
                JOIN DanhMucSanPham dm ON MaDanhMuc = dm.MaDanhMuc
                ...
                payload: {
                  richContent: [
                    [
                      ...
                      {
                        type: "button",
                        icon: { type: "forum", color: "#0084FF" },
                        text: "Hỗ trợ qua Messenger",
                        link: mesLink,
                      },
                      {
                        type: "button",
    ...
    try {
      ...
      if (rows.length > 0) {
        ...
        if (trangThai === 0 || trangThai === 1) {
          const processText = `Dạ đơn hàng số ${maDonReal} đang trong quá trình xử lý. Để thay đổi thông tin, bạn vui lòng liên hệ Zalo, Messenger hoặc Gọi trực tiếp cho CSKH để cập nhật gấp nhé ạ!`;
          return res.json({
            fulfillmentMessages: [
    ...
    const textResponse =
      "Dạ CeramicShop vô cùng xin lỗi bạn về trải nghiệm không tốt này. Để shop xử lý đền bù/đổi trả ngay lập tức, bạn vui lòng liên hệ ngay qua Hotline, Zalo, Messenger hoặc Email để bộ phận CSKH giải quyết ngay nhé ạ.";
            ...
            richContent: [
              [
                ...
                },
                {
                  type: "button",
                  icon: { type: "forum", color: "#0084FF" },
                  text: "Gửi ảnh/video qua Messenger",
                  link: mesLink,
                },
                {
                  type: "button",
    ...
    const textResponse =
      "Dạ, bạn có thể gọi trực tiếp, nhắn Zalo, Messenger hoặc gửi Email để chuyên viên gốm sứ bên em hỗ trợ bạn chu đáo nhất nhé ạ!";
            ...
            richContent: [
              [
                ...
                },
                {
                  type: "button",
                  icon: { type: "forum", color: "#0084FF" },
                  text: "Chat với CSKH qua Messenger",
                  link: mesLink,
                },
                {
                  type: "button",
