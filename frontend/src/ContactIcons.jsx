...
const ContactIcons = () => {
  ...
  const icons = {
    ...
    arrow: 'https://cdn-icons-png.flaticon.com/512/271/271239.png',
  ...
  return (
    <div className={`contact-wrapper ${isOpen ? 'open' : ''}`}>
      <button className="contact-toggle-btn" onClick={toggleContact} title="Liên hệ">
        <img src={icons.mainPhone} alt="Phone" className="main-phone-icon" />
        <img src={icons.arrow} alt="Arrow" className="main-arrow-icon" />
      </button>
      ...
      <div className="contact-list">
        ...
        <a 
          href="https://www.facebook.com/CeramicShop/" 
          target="_blank" 
          rel="noopener noreferrer" 
