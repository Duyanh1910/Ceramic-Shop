...
const bannerSlides = [
  {
    id: 1,
    image:
      "https://images.unsplash.com/photo-1610701596007-11502861dcfa?q=80&w=1920&auto=format&fit=crop",
  ...
  },
  {
    id: 2,
    image:
      "https://res.cloudinary.com/dcmwz0uis/image/upload/v1775186597/porcelain-and-ceramics-1024x683_j22ily.jpg",
  ...
  },
  {
    id: 3,
    image:
      "https://res.cloudinary.com/dcmwz0uis/image/upload/v1775186648/blue-white-chinoiserie-design-497489_scgryl.jpg",
...
function LandingPage() {
  ...
  useEffect(() => {
    const checkOAuth = async () => {
      ...
      try {
        ...
        const token =
          res.data.token || res.data.result?.token || userData?.token;

        if (userData) {
          const role = userData.role || "Customer";
          const profileData = userData.profile || userData;
          const username =
            profileData.TenKhachHang || userData.username || "Thành viên";
  ...
  async function fetchProducts() {
    ...
    try {
      ...
      const mockProducts = [
        {
          MaSanPham: 1,
          TenSanPham: "Tượng Cá chép hóa rồng",
          GiaThapNhat: 850000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773370680/ca_chep_hoa_rong_1_qgbxrl.jpg",
        },
        {
          MaSanPham: 2,
          TenSanPham: "Tượng Thần Tài Biểu Tượng Tài Lộc",
          GiaThapNhat: 550000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773370053/than_tai_1_jvvsff.jpg",
        },
        {
          MaSanPham: 3,
          TenSanPham: "Tượng Di Lặc",
          GiaThapNhat: 680000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773369991/di_lac_1_w2hy7r.jpg",
        },
        {
          MaSanPham: 4,
          TenSanPham: "Lục bình Công đào họa tiết nổi",
          GiaThapNhat: 5000000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773369371/luc_binh_cong_dao_1_tq0p51.jpg",
        },
        {
          MaSanPham: 5,
          TenSanPham: "Lục bình Tứ quý",
          GiaThapNhat: 4200000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773369259/luc_binh_tu_quy_1_oagyg2.jpg",
        },
        {
          MaSanPham: 6,
          TenSanPham: "Mâm bồng vẽ vàng",
          GiaThapNhat: 1200000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773368756/mam_bong_vang_1_a9xuhc.jpg",
        },
        {
          MaSanPham: 7,
          TenSanPham: "Bát hương hoa sen men rạn",
          GiaThapNhat: 850000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773368705/bat_huong_sen_1_xov7f0.jpg",
        },
        {
          MaSanPham: 8,
          TenSanPham: "Bộ ấm trà tử sa đắp nổi",
          GiaThapNhat: 1550000,
          Thumbnail:
            "https://res.cloudinary.com/dcmwz0uis/image/upload/v1773368595/am_tra_tu_sa_1_z9v2n1.jpg",
        },
      ];
        ...
        label: (
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontWeight: 500, color: "#1b437c" }}>
                {item.TenSanPham}
              </span>
              <span
  ...
  const categories =
    apiCategories.length > 0
      ...
      : Object.entries(CATEGORY_IMGS).map(([name, img]) => ({
          id: null,
          name,
          img,
        }));
    ...
    <div className={styles.wrapper}>
      <Helmet>
        <title className={styles.title}>
          CeramicShop - Tinh Hoa Gốm Sứ Việt
        </title>
        <meta
          name="description"
          content="Nơi tinh hoa gốm sứ giao thoa cùng phong cách sống hiện đại"
        />
      </Helmet>
          ...
          <div className={styles.topbarInner}>
            <div className={styles.topbarLeft}>
              <span className={styles.topbarPromo}>
                🛡️ Bao bể vỡ - Cam kết 1 đổi 1 toàn quốc | 🎁 Nhập mã{" "}
                <strong>GOMSU10</strong> - Giảm ngay 10%
              </span>
            </div>
            ...
            <div className={styles.topbarRight}>
              ...
              <a
                href="https://maps.google.com/?q=484+Lạch+Tray,+Hải+Phòng"
                target="_blank"
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeading}>
            ...
            <p className={styles.sectionSubtitle}>
              Nơi Tinh Hoa Gốm Sứ Giao Thoa Cùng Phong Cách Sống Hiện Đại
            </p>
          </div>
          ...
          <div className={styles.aboutContent}>
            <div className={styles.aboutText}>
              <p>
                CeramicShop tự hào là thương hiệu mang đến những sản phẩm gốm sứ
                chất lượng cao, là sự kết tinh hoàn mỹ giữa tinh hoa nghệ thuật
                thủ công truyền thống và nhịp sống văn minh, hiện đại. Chúng tôi
                tin rằng, mỗi sản phẩm gốm sứ không chỉ đơn thuần là vật dụng
                phục vụ sinh hoạt hàng ngày, mà còn là những kiệt tác chứa đựng
                linh hồn của đất, nước, lửa và tâm huyết của những nghệ nhân tài
                hoa.
              </p>
              <p>
                CeramicShop ra đời với mong muốn tôn vinh sự sáng tạo và đưa bản
                sắc văn hóa dân tộc Việt Nam đến gần hơn với không gian sống của
                mỗi gia đình.
              </p>
            </div>
            <div className={styles.aboutImage}>
              <img
                src="https://res.cloudinary.com/dcmwz0uis/image/upload/v1775634050/pottery-decorative-ceramics-lookbooks_dezeen_2364_col_3-2048x1151_trj563.jpg"
                alt="Gốm sứ thủ công"
              />
            </div>
          </div>
          ...
          <div className={styles.visionMission}>
            <div
              className={`${styles.vmCard} ${styles.hiddenStart}`}
              ref={(el) => (vmRefs.current[0] = el)}
              style={{ transitionDelay: "0s" }}
            >
              <div
                className={styles.iconWrapper}
                style={{ backgroundColor: "#009bb6" }}
              >
                <TrophyOutlined className={styles.featureIcon} />
              </div>
              <h3>TẦM NHÌN</h3>
              <p>
                Xây dựng CeramicShop trở thành địa chỉ mua sắm gốm sứ trực tuyến
                thân thiện và đáng tin cậy, kết hợp hài hòa giữa nét đẹp truyền
                thống và công nghệ hiện đại.
              </p>
            </div>
            <div
              className={`${styles.vmCard} ${styles.hiddenStart}`}
              ref={(el) => (vmRefs.current[1] = el)}
              style={{ transitionDelay: "0.15s" }}
            >
              <div
                className={styles.iconWrapper}
                style={{ backgroundColor: "#eeb406" }}
              >
                <SafetyOutlined className={styles.featureIcon} />
              </div>
              <h3>SỨ MỆNH</h3>
              <p>
                Kiến tạo sự ấm cúng và an yên cho mọi gia đình thông qua những
                sản phẩm gốm sứ chất lượng, không ngừng cải thiện dịch vụ và tôn
                vinh nét đẹp văn hóa Việt.
              </p>
            </div>
            <div
              className={`${styles.vmCard} ${styles.hiddenStart}`}
              ref={(el) => (vmRefs.current[2] = el)}
            ...
            >
              ...
              <p>
                Sản phẩm mang giá trị văn hóa và nghệ thuật sâu sắc. Mối quan hệ
                bền vững với sự uy tín, minh bạch. Thương hiệu chuyên nghiệp,
                ...
                >
                  <div className={styles.marqueeImgWrap}>
                    ...
                    <div className={styles.marqueeTextWrap}>
                      ...
                      <span className={styles.marqueeSubText}>
                        Khám phá chi tiết
                      </span>
                    </div>
                  </div>
              ...
              {products.map((p) => (
                ...
                >
                  ...
                  <div className={styles.productInfo}>
                    <h3 className={styles.productName} title={p.TenSanPham}>
                      {p.TenSanPham}
                    </h3>
                    <div className={styles.productPrice}>
                      {formatPrice(p.GiaThapNhat)}
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section id="news" className={styles.newsSection}>
        <div className={styles.container}>
          <div className={styles.sectionHeading}>
            ...
            <p className={styles.sectionSubtitle}>
              Cập nhật xu hướng và kiến thức về gốm sứ
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className={styles.newsContent}>
                      ...
                      <p className={styles.newsExcerpt}>
                        {article.NoiDung
                          ? article.NoiDung.replace(/<[^>]+>/g, "").substring(
                              0,
                              120,
                            ) + "..."
